...
function NewIncentiveForm({ incentiveFormData, uiState, handlers }) {
    ...
    return (
        <form action="" onClick={handlers.handleIncentiveFormSubmit}>
            <fieldset>
            ...
            <GeneralButton buttonType="button" buttonText="Submit" value="submit" />
            <GeneralButton buttonType="button" buttonText="Submit and next" value="submitAnother" />
        </form>
    )
}
